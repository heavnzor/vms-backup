!(function (e, t) {
  ...
  var C = (function (e) {
    ...
    try {
      H.apply ((D = O.call (w.childNodes)), w.childNodes), D[
        w.childNodes.length
      ].nodeType;
    } catch (t) {
      H = {
    ...
    for (t in ((n = se.support = {}), (o = se.isXML = function (e) {
      ...
      return a != d &&
        9 === a.nodeType &&
        a.documentElement &&
        ((h = (d = a).documentElement), (g = !o (d)), w != d &&
          (i = d.defaultView) &&
          i.top !== i &&
          (i.addEventListener
          ...
          }), (y = []), (v = []), (n.qsa = K.test (d.querySelectorAll)) &&
          (ce (function (e) {
            var t;
            ...
            t.setAttribute (
              'type',
              'hidden'
            ), e.appendChild (t).setAttribute ('name', 'D'), e.querySelectorAll ('[name=d]').length && v.push ('name' + M + '*[*^$|!~]?='), 2 !== e.querySelectorAll (':enabled').length && v.push (':enabled', ':disabled'), (h.appendChild (e).disabled = !0), 2 !== e.querySelectorAll (':disabled').length && v.push (':enabled', ':disabled'), e.querySelectorAll ('*,:x'), v.push (',.*:');
          ...
          ce (function (e) {
            (n.disconnectedMatch = m.call (
              e,
              '*'
            )), m.call (e, "[s!='']:x"), y.push ('!=', F);
          }), (v = v.length && new RegExp (v.join ('|'))), (y =
          y.length && new RegExp (y.join ('|'))), (t = K.test (
      ...
      var i = r.attrHandle[t.toLowerCase ()],
        o = i && j.call (r.attrHandle, t.toLowerCase ())
          ? i (e, t, !g)
          : void 0;
      return void 0 !== o
        ? o
      ...
      var t, r = [], i = 0, o = 0;
      if (
        ((f = !n.detectDuplicates), (c = !n.sortStable && e.slice (0)), e.sort (
          N
        ), f)
      ) {
        for (; (t = e[o++]); )
    ...
    function Ce (e, t, n, r, i, o) {
      return r && !r[b] && (r = Ce (r)), i &&
        !i[b] &&
        (i = Ce (i, o)), le (function (o, a, s, u) {
        var l,
          c,
          f,
          p = [],
    ...
    return (me.prototype = r.filters =
      r.pseudos), (r.setFilters = new me ()), (a = se.tokenize = function (
      e,
      t
    ) {
      ...
      if (!v) {
        ...
        (v = k (
          e,
          ((i = h), (s = 0 < (o = f).length), (u =
            0 < i.length), (c = function (e, t, n, a, c) {
            var f,
              h,
              v,
              y = 0,
      ...
      b.split ('').sort (N).join ('') ===
      b), (n.detectDuplicates = !!f), p (), (n.sortDetached = ce (function (e) {
  ...
  ((w.fn.init = function (e, t, n) {
    ...
    if (((n = n || D), 'string' == typeof e)) {
      ...
      if (r[1]) {
        if (
          ((t = t instanceof w ? t[0] : t), w.merge (
            this,
  ...
  }), w.each (
    {
      ...
      contents: function (e) {
        return null != e.contentDocument && r (e.contentDocument)
          ? e.contentDocument
          : (A (e, 'template') && (e = e.content || e), w.merge (
              [],
              e.childNodes
            ));
      },
    ...
    function (e, t) {
      w.fn[e] = function (n, r) {
        ...
        return 'Until' !== e.slice (-5) && (r = n), r &&
          'string' == typeof r &&
          (i = w.filter (r, i)), 1 < this.length &&
          (H[e] || w.uniqueSort (i), L.test (e) &&
  ...
  (w.Callbacks = function (e) {
    var t, n;
    e = 'string' == typeof e
      ? ((t = e), (n = {}), w.each (t.match (P) || [], function (e, t) {
          n[t] = !0;
        }), n)
      : w.extend ({}, e);
    var r,
      ...
      f = {
        add: function () {
          return s &&
            (i && !r && ((l = s.length - 1), u.push (i)), (function t (n) {
          ...
          then: function (t, r, i) {
              ...
              return function () {
                    ...
                    : function () {
                        try {
                          ...
                          w.Deferred.exceptionHook &&
                            w.Deferred.exceptionHook (e, c.stackTrace), o <=
                            t + 1 &&
                            (r !== M &&
                ...
                t
                  ...
                  : (w.Deferred.getStackHook &&
                      (c.stackTrace = w.Deferred.getStackHook ()), e.setTimeout (
                      c
                    ));
              };
            }
            return w
              .Deferred (function (e) {
                ...
                ), n[1][3].add (a (0, e, h (t) ? t : R)), n[2][3].add (a (0, e, h (r) ? r : M));
              })
              .promise ();
          },
          promise: function (e) {
    ...
    when: function (e) {
      var t = arguments.length,
        ...
        s = function (e) {
          return function (n) {
            (r[e] = this), (o[e] = 1 < arguments.length
              ? i.call (arguments)
              : n), --t || a.resolveWith (r, o);
          };
        };
      if (
        t <= 1 &&
        (I (e, a.done (s (n)).resolve, a.reject, !t), 'pending' ===
          a.state () || h (o[n] && o[n].then))
      )
        return a.then ();
      for (; n--; )
        I (o[n], s (n), a.reject);
  ...
  function B () {
    v.removeEventListener (
      'DOMContentLoaded',
      B
    ), e.removeEventListener ('load', B), w.ready ();
  }
  ...
  (ge.tbody = ge.tfoot = ge.colgroup = ge.caption =
    ge.thead), (ge.th = ge.td), d.option || (ge.optgroup = ge.option = [1, "<select multiple='multiple'>", '</select>']);
  var me = /<|&#?\w+;/;
  ...
  function Ee (e, t, n, r, i, o) {
    ...
    return 1 === o &&
      ((a = i), ((i = function (e) {
        ...
        a.guid || (a.guid = w.guid++))), e.each (function () {
      w.event.add (this, t, i, r, n);
    });
  }
  function Se (e, t, n) {
    n
      ? (Y.set (e, t, !1), w.event.add (e, t, {
          namespace: !1,
          handler: function (e) {
            ...
            if (1 & e.isTrigger && this[t]) {
              if (a.length)
                ...
                ((a = i.call (arguments)), Y.set (this, t, a), (r = n (
                  this,
                  t
                )), this[t] (), a !== (o = Y.get (this, t)) || r
                  ? Y.set (this, t, !1)
                  : (o = {}), a !== o)
              )
      ...
      if (V (e))
        for (
          n.handler && ((n = (o = n).handler), (i = o.selector)), i &&
            w.find.matchesSelector (re, i), n.guid || (n.guid = w.guid++), (u =
            v.events) || (u = v.events = Object.create (null)), (a =
            v.handle) ||
          ...
          (d = g = (s = be.exec (t[l]) || [])[1]), (h = (s[2] || '')
            .split ('.')
            .sort ()), d &&
            ((f = w.event.special[d] || {}), (d =
              (i ? f.delegateType : f.bindType) || d), (f = w.event.special[
              d
            ] || {}), (c = w.extend (
              {
                type: d,
              ...
              (((p = u[d] = []).delegateCount = 0), (f.setup &&
                ...
                (e.addEventListener && e.addEventListener (d, a))), f.add &&
          ...
          if (
            ...
            a &&
              ...
              ((f.teardown && !1 !== f.teardown.call (e, h, v.handle)) ||
                w.removeEvent (e, d, v.handle), delete u[d]);
          ...
          for (
            ...
            (u.rnamespace &&
              ...
              ((u.handleObj = o), (u.data = o.data), void 0 !==
                (r = ((w.event.special[o.origType] || {}).handle || o.handler)
                  .apply (i.elem, s)) &&
                !1 === (u.result = r) &&
  ...
  }), w.each ({altKey: !0, bubbles: !0, cancelable: !0, changedTouches: !0, ctrlKey: !0, detail: !0, eventPhase: !0, metaKey: !0, pageX: !0, pageY: !0, shiftKey: !0, view: !0, char: !0, code: !0, charCode: !0, key: !0, keyCode: !0, button: !0, buttons: !0, clientX: !0, clientY: !0, offsetX: !0, offsetY: !0, pointerId: !0, pointerType: !0, screenX: !0, screenY: !0, targetTouches: !0, toElement: !0, touches: !0, which: !0}, w.event.addProp), w.each (
    ...
    function (e, t) {
      w.event.special[e] = {
        ...
        handle: function (e) {
          ...
          return (r && (r === this || w.contains (this, r))) ||
            ((e.type = i.origType), (n = i.handler.apply (
              this,
              arguments
            )), (e.type = t)), n;
        },
  ...
  function He (e, t, n, r) {
    ...
    if (
      p &&
      ((a = (i = xe (t, e[0].ownerDocument, !1, e, r)).firstChild), 1 ===
        i.childNodes.length && (i = a), a || r)
    ) {
      for (u = (s = w.map (ve (i, 'script'), De)).length; f < p; f++)
        (l = i), f !== g &&
          ((l = w.clone (l, !0, !0)), u &&
            w.merge (s, ve (l, 'script'))), n.call (e[f], l, f);
      if (u)
        for (
    ...
    clone: function (e, t, n) {
      ...
      if (
        ...
        for ((a = ve (c)), (r = 0), (i = (o = ve (e)).length); r < i; r++)
          (s = o[r]), 'input' === (l = (u = a[r]).nodeName.toLowerCase ()) &&
            pe.test (s.type)
            ? (u.checked = s.checked)
            : ('input' !== l && 'textarea' !== l) ||
    ...
    function (e, t) {
      w.fn[e] = function (e) {
        for (var n, r = [], i = w (e), o = i.length - 1, s = 0; s <= o; s++)
          (n = s === o ? this : this.clone (!0)), w (i[s])[t] (n), a.apply (
            r,
            n.get ()
          );
  ...
  function We (e, t, n) {
    ...
    return (n = n || Re (e)) &&
      ('' !== (a = n.getPropertyValue (t) || n[t]) ||
        ie (e) ||
        (a = w.style (e, t)), !d.pixelBoxStyles () &&
        Pe.test (a) &&
        Ie.test (t) &&
  ...
  !(function () {
    function t () {
      if (c) {
        ...
        (r = '1%' !== t.top), (u = 12 === n (t.marginLeft)), (c.style.right =
          '60%'), (a = 36 === n (t.right)), (i =
          36 === n (t.width)), (c.style.position = 'absolute'), (o =
          12 === n (c.offsetWidth / 3)), re.removeChild (l), (c = null);
      }
    }
    function n (e) {
    ...
    c.style &&
      ((c.style.backgroundClip = 'content-box'), (c.cloneNode (
        !0
      ).style.backgroundClip =
        ''), (d.clearCloneStyle =
        'content-box' === c.style.backgroundClip), w.extend (d, {
        ...
        reliableTrDimensions: function () {
          var t, n, r, i;
          return null == s &&
            ((t = v.createElement ('table')), (n = v.createElement (
              'tr'
            )), (r = v.createElement ('div')), (t.style.cssText =
              'position:absolute;left:-11111px;border-collapse:separate'), (n.style.cssText =
              'border:1px;solid'), (n.style.height = '1px'), (r.style.height =
              '9px'), (r.style.display = 'block'), re
              .appendChild (t)
              .appendChild (n)
              .appendChild (r), (i = e.getComputedStyle (n)), (s =
              parseInt (i.height, 10) +
                parseInt (i.borderTopWidth, 10) +
                parseInt (i.borderBottomWidth, 10) ===
              n.offsetHeight), re.removeChild (t)), s;
        },
      }));
  }) ();
  ...
  w.extend ({
    ...
    style: function (e, t, n, r) {
      if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
        ...
        if (
          (u || (t = ze (s)), (a = w.cssHooks[t] || w.cssHooks[s]), void 0 ===
            n)
        )
        ...
        'string' == (o = typeof n) &&
          ...
          ('number' !== o ||
            u ||
            (n +=
              (i && i[3]) || (w.cssNumber[s] ? '' : 'px')), d.clearCloneStyle ||
            '' !== n ||
    ...
    w.cssHooks[t] = {
      ...
      set: function (e, n, r) {
        ...
        return s &&
          ...
          (i = te.exec (n)) &&
          'px' !== (i[3] || 'px') &&
          ((e.style[t] = n), (n = w.css (e, t))), Ye (0, n, u);
      },
    };
  ...
  function ot () {
    et &&
      (!1 === v.hidden && e.requestAnimationFrame
        ...
        : e.setTimeout (ot, w.fx.interval), w.fx.tick ());
  }
  function at () {
  ...
  function lt (e, t, n) {
    ...
    return w.map (
      ...
      ut,
      l
    ), h (l.opts.start) && l.opts.start.call (e, l), l.progress (l.opts.progress).done (l.opts.done, l.opts.complete).fail (l.opts.fail).always (l.opts.always), w.fx.timer (w.extend (u, {elem: e, anim: l, queue: l.opts.queue})), l;
  }
  (w.Animation = w.extend (lt, {
        ...
        if ((u = !w.isEmptyObject (t)) || !w.isEmptyObject (d))
          for (r in (f &&
            ...
            ((n.overflow = [h.overflow, h.overflowX, h.overflowY]), null ==
              ...
              (l
                ? (c = l)
                : (le ([e], !0), (l = e.style.display || l), (c = w.css (
                    e,
                    'display'
                  )), le ([e]))), ('inline' === c ||
            ...
            u ||
              (v
                ...
                for (r in (g ||
                  le ([e]), Y.remove (e, 'fxshow'), d)) w.style (e, r, d[r]);
    ...
    return (t = (w.fx && w.fx.speeds[t]) || t), (n =
    ...
    'input'
  )), (nt = v.createElement ('select').appendChild (v.createElement ('option'))), (tt.type = 'checkbox'), (d.checkOn = '' !== tt.value), (d.optSelected = nt.selected), ((tt = v.createElement ('input')).value = 't'), (tt.type = 'radio'), (d.radioValue = 't' === tt.value);
  ...
  w.fn.extend ({
        ...
        return void 0 === e.getAttribute
          ...
          : ((1 === o && w.isXMLDoc (e)) ||
              (i =
                ...
                (w.expr.match.bool.test (t) ? ct : void 0)), void 0 !== n
              ? null === n
    ...
    ft[t] = function (e, t, r) {
      ...
      return r ||
        ((o = ft[a]), (ft[a] = i), (i = null != n (e, t, r) ? a : null), (ft[
          a
        ] = o)), i;
    };
  });
        ...
        : h (e)
            ...
            : this.each (function () {
                ...
                if (r)
                  ...
                  (void 0 !== e && 'boolean' !== n) ||
                    ((t = gt (this)) && Y.set (this, '__className__', t), this
                      .setAttribute &&
                      this.setAttribute (
                        'class',
  ...
  w.extend (w.event, {
    trigger: function (t, n, r, i) {
      ...
      if (
        ((a = d = s = r = r || v), 3 !== r.nodeType &&
          8 !== r.nodeType &&
          !mt.test (m + w.event.triggered) &&
          (-1 < m.indexOf ('.') &&
            ((m = (x = m.split ('.')).shift ()), x.sort ()), (l =
            m.indexOf (':') < 0 && 'on' + m), ((t = t[w.expando]
            ? t
            : new w.Event (m, 'object' == typeof t && t)).isTrigger = i
            ? 2
            : 3), (t.namespace = x.join ('.')), (t.rnamespace = t.namespace
            ? new RegExp ('(^|\\.)' + x.join ('\\.(?:.*\\.|)') + '(\\.|$)')
            : null), (t.result = void 0), t.target ||
            (t.target = r), (n = null == n ? [t] : w.makeArray (n, [t])), (p = w
            .event.special[m] || {}), i ||
            !p.trigger ||
        ...
        for (o = 0; (a = y[o++]) && !t.isPropagationStopped (); )
          (d = a), (t.type = 1 < o ? u : p.bindType || m), (f =
            (Y.get (a, 'events') || Object.create (null))[t.type] &&
            Y.get (a, 'handle')) && f.apply (a, n), (f = l && a[l]) &&
            f.apply &&
            V (a) &&
            ((t.result = f.apply (a, n)), !1 === t.result &&
              t.preventDefault ());
        return (t.type = m), i ||
          ...
          (l &&
            ...
            ((s = r[l]) &&
              (r[
                l
              ] = null), (w.event.triggered = m), t.isPropagationStopped () &&
              d.addEventListener (m, xt), r[m] (), t.isPropagationStopped () &&
              d.removeEventListener (m, xt), (w.event.triggered = void 0), s &&
              (r[l] = s))), t.result;
      }
    },
  ...
  w.parseXML = function (t) {
    ...
    return (r = n && n.getElementsByTagName ('parsererror')[0]), (n && !r) ||
      w.error (
        'Invalid XML: ' +
          (r
            ? w
  ...
  (Mt.href = bt.href), w.extend ({
    ...
    ajax: function (t, n) {
      ...
      var r,
        ...
        E = {
          ...
          setRequestHeader: function (e, t) {
            return null == l &&
              ((e = T[e.toLowerCase ()] = T[e.toLowerCase ()] || e), (b[
                e
              ] = t)), this;
          },
      ...
      if (
        (y.promise (E), (d.url = ((t || d.url || bt.href) + '').replace (
          Ht,
          bt.protocol + '//'
        )), (d.type =
          n.method ||
          n.type ||
          d.method ||
          d.type), (d.dataTypes = (d.dataType || '*')
          .toLowerCase ()
          .match (P) || ['']), null == d.crossDomain)
      ) {
        u = v.createElement ('a');
        try {
          (u.href = d.url), (u.href = u.href), (d.crossDomain =
      ...
      if (
        (d.data &&
          ...
          (d.data = w.param (d.data, d.traditional)), Wt (Ot, d, n, E), l)
      )
        return E;
      for (f in ((c = w.event && d.global) &&
        ...
        w.event.trigger (
          'ajaxStart'
        ), (d.type = d.type.toUpperCase ()), (d.hasContent = !Lt.test (
        d.type
      )), (i = d.url.replace (jt, '')), d.hasContent
        ? d.data &&
            d.processData &&
            0 ===
              (d.contentType || '')
        ...
        : ((p = d.url.slice (i.length)), d.data &&
            (d.processData || 'string' == typeof d.data) &&
            ((i += (Tt.test (i) ? '&' : '?') + d.data), delete d.data), !1 ===
            d.cache &&
            ((i = i.replace (Dt, '$1')), (p =
              (Tt.test (i) ? '&' : '?') + '_=' + wt.guid++ + p)), (d.url =
            i + p)), d.ifModified &&
        (w.lastModified[i] &&
          E.setRequestHeader ('If-Modified-Since', w.lastModified[i]), w.etag[
          i
        ] && E.setRequestHeader ('If-None-Match', w.etag[i])), ((d.data &&
        d.hasContent &&
        !1 !== d.contentType) ||
        n.contentType) &&
        E.setRequestHeader ('Content-Type', d.contentType), E.setRequestHeader (
        'Accept',
      ...
      if (d.beforeSend && (!1 === d.beforeSend.call (h, E, d) || l))
        return E.abort ();
      if (
        ((C = 'abort'), m.add (d.complete), E.done (d.success), E.fail (
          d.error
        ), (r = Wt (Pt, d, n, E)))
      ) {
      ...
      function S (t, n, a, u) {
        var f, p, v, b, T, C = n;
        l ||
          ((l = !0), s && e.clearTimeout (s), (r = void 0), (o =
            u || ''), (E.readyState = 0 < t ? 4 : 0), (f =
            (200 <= t && t < 300) || 304 === t), a &&
            (b = (function (e, t, n) {
              for (
            ...
            (d.converters['text script'] = function () {}), (b = (function (
            e,
            t,
            n,
            r
            ...
            ? (d.ifModified &&
                ((T = E.getResponseHeader ('Last-Modified')) &&
                  (w.lastModified[i] = T), (T = E.getResponseHeader ('etag')) &&
                  (w.etag[i] = T)), 204 === t || 'HEAD' === d.type
                ? (C = 'nocontent')
                : 304 === t
                    ? (C = 'notmodified')
            ...
            : ((v = C), (!t && C) ||
                ((C = 'error'), t < 0 &&
                  (t = 0))), (E.status = t), (E.statusText = (n || C) + ''), f
            ? y.resolveWith (h, [p, C, E])
            : y.rejectWith (h, [E, C, v]), E.statusCode (x), (x = void 0), c &&
            g.trigger (f ? 'ajaxSuccess' : 'ajaxError', [
              E,
              d,
              f ? p : v,
            ]), m.fireWith (h, [E, C]), c &&
            (g.trigger ('ajaxComplete', [E, d]), --w.active ||
    ...
    w[t] = function (e, n, r, i) {
      return h (n) && ((i = i || r), (r = n), (n = void 0)), w.ajax (
        w.extend (
    ...
    wrapAll: function (e) {
      var t;
      return this[0] &&
        (h (e) && (e = e.call (this[0])), (t = w (e, this[0].ownerDocument)
          .eq (0)
  ...
  (d.cors =
    !!$t &&
    'withCredentials' in $t), (d.ajax = $t = !!$t), w.ajaxTransport (function (
    t
  ) {
    var n, r;
  ...
  w.ajaxSetup ({
    ...
    if (s || 'jsonp' === t.dataTypes[0])
      return (i = t.jsonpCallback = h (t.jsonpCallback)
        ? t.jsonpCallback ()
        : t.jsonpCallback), s
        ? (t[s] = t[s].replace (Ut, '$1' + i))
        : !1 !== t.jsonp &&
            (t.url +=
              (Tt.test (t.url) ? '&' : '?') + t.jsonp + '=' + i), (t.converters[
        'script json'
      ] = function () {
        ...
        void 0 === o
          ...
          : (e[
              i
            ] = o), t[i] && ((t.jsonpCallback = n.jsonpCallback), zt.push (i)), a && h (o) && o (a[0]), (a = o = void 0);
      }), 'script';
  }), (d.createHTMLDocument = (((_t = v.implementation.createHTMLDocument ('')
    .body).innerHTML =
    '<form></form><form></form>'), 2 ===
    _t.childNodes.length)), (w.parseHTML = function (e, t, n) {
    return 'string' != typeof e
      ? []
      : ('boolean' == typeof t && ((n = t), (t = !1)), t ||
          (d.createHTMLDocument
            ? (((r = (t = v.implementation.createHTMLDocument (
                ...
                v.location.href), t.head.appendChild (r))
            : (t = v)), (o = !n && []), (i = N.exec (e))
          ? [t.createElement (i[1])]
          : ((i = xe ([e], t, o)), o && o.length && w (o).remove (), w.merge (
              [],
              i.childNodes
            )));
  }), (w.fn.load = function (e, t, n) {
    var r, i, o, a = this, s = e.indexOf (' ');
    return -1 < s && ((r = ht (e.slice (s))), (e = e.slice (0, s))), h (t)
      ? ((n = t), (t = void 0))
    ...
    setOffset: function (e, t, n) {
      ...
      'static' === l &&
        (e.style.position = 'relative'), (s = c.offset ()), (o = w.css (
        e,
        'top'
      )), (u = w.css (e, 'left')), ('absolute' === l || 'fixed' === l) &&
        -1 < (o + u).indexOf ('auto')
        ? ((a = (r = c.position ()).top), (i = r.left))
        : ((a = parseFloat (o) || 0), (i = parseFloat (u) || 0)), h (t) &&
  ...
  }), (w.isArray = Array.isArray), (w.parseJSON = JSON.parse), (w.nodeName = A), (w.isFunction = h), (w.isWindow = g), (w.camelCase = X), (w.type = x), (w.now = Date.now), (w.isNumeric = function (
    e
  ) {
    var t = w.type (e);
